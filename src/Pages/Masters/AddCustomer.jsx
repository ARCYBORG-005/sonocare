...
const AddCustomer = ({ customers, setCustomers }) => {
  ...
  // 1. AUTO-GENERATE NEXT CUSTOMER ID
  ...
  // 3. INITIAL CONTACTS STATE (Contact 1 = Primary)
  ...
  const handleConfirmDeleteContact = () => {
    ...
    toast.success('Contact removed from form.');
  };
  ...
  const handleSubmit = (e) => {
    ...
    const newCustomer = {
      ...
      createdBy: `${mockEmployeeData.employeeId} (${mockEmployeeData.name})`,
      ...
      contacts: contacts.map((c) => ({
        ...
        role: c.role.trim(),
        phone1: c.phone1.trim(),
        phone2: c.phone2 ? c.phone2.trim() : '',
  ...
  return (
    <div className="customer-master-page container-fluid px-0 px-md-1">
      <Helmet>
        <title>Add Customer | Sonocare CRM</title>
        <meta name="description" content="Add a new healthcare customer record in Sonocare CRM." />
      </Helmet>
      <ToastContainer />
      ...
      <div className="category-page-header mb-4">
        <div className="category-page-title-group">
          ...
          <h1 className="category-page-title">Add Customer</h1>
        </div>
      </div>
          ...
          <div className="card-body p-4">
            <div className="row g-3">
              ...
              <div className="col-12 col-md-6">
                <InputField
                  label="Customer Name"
                  placeholder="e.g. Apollo Hospitals Main Branch"
                  required={true}
              ...
              <div className="col-12 col-md-6">
                <InputField
                  ...
                  placeholder="e.g. 33AAAAC1234F1Z5"
                ...
                <div className="row g-3">
                  ...
                  <div className="col-12 col-md-6">
                    <InputField
                      ...
                      type="email"
                      placeholder="e.g. drkumar@apollohospitals.com"
                      value={contact.email}
